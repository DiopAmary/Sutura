 ...
 * @Route("/declar/remboursement")
 */
class DeclarRemboursementController extends AbstractController
{
    /**
	 *IsGranted("ROLE_ADMIN")
     * @Route("/", name="declar_remboursement_index", methods={"GET"})
     */
    ...
    /**
     * @Route("{id}/new", name="declar_remboursement_new", methods={"GET","POST"})
     */
    ...
    /**
	 *IsGranted("ROLE_ADMIN")
     * @Route("/{id}", name="declar_remboursement_show", methods={"GET"})
     */
    ...
    /**
	 *IsGranted("ROLE_ADMIN")
     * @Route("/{id}/edit", name="declar_remboursement_edit", methods={"GET","POST"})
     */
    ...
    /**
	 *IsGranted("ROLE_ADMIN")
     * @Route("/{id}", name="declar_remboursement_delete", methods={"DELETE"})
     */
